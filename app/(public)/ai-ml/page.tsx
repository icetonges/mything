...
import { Brain, ExternalLink, Code, BookOpen, Lightbulb, GitBranch, Check, X, AlertCircle, Terminal, FileText, TrendingUp, Zap, ArrowUp, Sparkles } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-lg text-[hsl(var(--fg-muted))] max-w-3xl mb-4">
                Complete reference: ML algorithms, evaluation metrics, clustering, AI agents, and real-world DoD applications
              </p>

              {/* NEW: ML AI Hub Highlight */}
              <div className="p-4 rounded-xl border-2 border-purple-500/30 bg-gradient-to-r from-purple-500/5 to-blue-500/5 mb-4">
                <div className="flex items-start gap-3">
                  <Sparkles size={18} className="text-purple-400 shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold text-sm mb-1 text-purple-300">
                      🎉 New: Interactive ML AI Knowledge Hub App
                    </h3>
                    <p className="text-xs text-[hsl(var(--fg-muted))] leading-relaxed mb-2">
                      This comprehensive guide is now available as a standalone web app at <strong>mlaithing.vercel.app</strong> — 
                      featuring all 8+ algorithms with production code, clustering techniques, AI agents framework, 
                      and real-world DoD use cases in an interactive format.
                    </p>
                    <a href="https://mlaithing.vercel.app" target="_blank" rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-purple-500/40 bg-purple-500/10 text-xs font-semibold hover:bg-purple-500/20 transition-all">
                      <Brain size={12} />
                      Visit ML AI Hub App
          ...
          {/* UPDATED: Replace Kaggle button with ML AI Hub */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <a href="#ml-section" className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-purple-500/30 bg-purple-500/10 font-semibold text-sm hover:border-purple-500/50 transition-all">
            ...
            <a href="https://mlaithing.vercel.app" target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl gold-bg font-semibold text-sm hover:opacity-90 transition-opacity">
              <Brain size={16} />ML AI Hub
