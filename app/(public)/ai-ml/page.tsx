...
import { Brain, ExternalLink, Code, BookOpen, Zap, Sparkles } from "lucide-react";
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-10">
        ...
        <p className="text-[hsl(var(--fg-muted))] max-w-2xl mb-6">
        ...
        {/* NEW: ML AI Hub Highlight Section */}
        <div className="p-5 rounded-xl border-2 border-purple-500/30 bg-gradient-to-r from-purple-500/5 to-blue-500/5 mb-6">
          <div className="flex items-start gap-3">
            <Sparkles size={20} className="text-purple-400 shrink-0 mt-0.5" />
            <div>
              <h3 className="font-semibold text-base mb-2 text-purple-300 flex items-center gap-2">
                🎉 New: Comprehensive ML AI Knowledge Hub
              </h3>
              <p className="text-sm text-[hsl(var(--fg-muted))] leading-relaxed mb-3">
              ...
              <a href="https://mlaithing.vercel.app" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border-2 border-purple-500/50 bg-purple-500/10 text-sm font-semibold hover:bg-purple-500/20 hover:border-purple-500/70 transition-all">
